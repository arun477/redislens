...
if os.path.exists(client_build_dir):
    ...
    print(f"Warning: Client build directory not found at {client_build_dir}")
    print("Please run 'npm run build' in the client directory first")
...
async def get_index():
    ...
    if os.path.exists(index_path):
        ...
        raise HTTPException(status_code=404, detail="Client build not found. Please run 'npm run build' in the client directory.")
